      ...
      <div>
        {user ? (
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <p className="text-gray-600 max-sm:hidden pl-4">Hi, Deep</p>
...
//   const navigate = useNavigate();
//   return (
//     <div className="fixed top-0 left-0 w-full z-50 shadow-md flex items-center justify-between py-4 px-6 bg-gradient-to-b from-teal-50 to-orange-50">
//       <Link to="/">
//         <img src={assets.logo} alt="" className="w-28 sm:w-32 lg:w-40" />
//       </Link>
